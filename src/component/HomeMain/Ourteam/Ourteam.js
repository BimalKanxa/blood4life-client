...
const Ourteam = () => {
    return (
        <div className='row mt-5 mx-3 team-fild'>
           ...
           <Card.Body>
            <Card.Subtitle className=" mt-5 text-muted">Bimal</Card.Subtitle>
           ...
           <Card.Body>
            <Card.Subtitle className="mt-5 text-muted">Mr. Rahul </Card.Subtitle>
            <Card.Text className='card-text'>
            Some quick example text to build on the card title and make up the bulk of
            the card's content.
            </Card.Text>
           ...
           <Card.Body>
            <Card.Subtitle className="mt-5 text-muted">Baroon</Card.Subtitle>
            <Card.Text className='card-text'>
            Some quick example text to build on the card title and make up the bulk of
            the card's content.
            </Card.Text>
